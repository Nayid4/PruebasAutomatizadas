...
def test_ver_lista_seguimiento(driver):
    ...
    lista_seguimiento_link = driver.find_element(By.ID, "pt-watchlist-2")
    lista_seguimiento_link.click()

    # Verificar la página de la lista de seguimiento
    titulo_pagina = driver.find_element(By.CSS_SELECTOR, ".firstHeading").text
    assert "Lista de seguimiento" in titulo_pagina
